...
import { Button, Row, Col, Card, CardHeader, CardTitle, CardBody, Table } from 'reactstrap';

import breadcrumb from './BreadCrumb'
import ViewBreadCrumb from '../../../../views/BreadCrumb'

function DetailsComponent(props) {
    const candidato = props.candidato[0]
                            ...
                            <Table style={{ background: '#fff'}}>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{ candidato.rg }</td>
                                        <td>{ formatData(candidato.dataNascimento) }</td>
                                    </tr>
                                </tbody>
                            </Table>
                        </Row>
